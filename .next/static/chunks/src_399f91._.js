(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_399f91._.js", {
        ...
        "PostManager.useEffect": ()=>{
            if (isChecked && interval > 0) {
                const id = window.setInterval({
                    "PostManager.useEffect.id": ()=>{
                        if (receivedAnswer.trim()) {
                            handleSendMessage();
                        }
                    }
                }["PostManager.useEffect.id"], interval * 3600000);
                setIntervalId(id);
...
_s(PostManager, "F4VNULOiqgO/HAo5EV2AaSJZ6J0=", false, function() {
    return [
...
//# sourceMappingURL=src_399f91._.js.map