(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_3c64bf._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/router.js [app-client] (ecmascript)"); // Імпорт useRouter для редиректу
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$auth$2d$helpers$2d$nextjs$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@supabase/auth-helpers-nextjs/dist/index.js [app-client] (ecmascript)"); // Клієнтський Supabase
;
var _s = __turbopack_refresh__.signature();
"use client";
;
...
function RootLayout({ children }) {
    _s();
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Додаємо стан для відображення лоадера
    const [isAuthenticated, setIsAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // Стан автентифікації
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])(); // Для виконання редиректу
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RootLayout.useEffect": ()=>{
            const checkAuth = {
                "RootLayout.useEffect.checkAuth": async ()=>{
                    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$auth$2d$helpers$2d$nextjs$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClientComponentClient"])(); // Ініціалізація клієнта Supabase
                    const { data: { session }, error } = await supabase.auth.getSession();
                    if (error || !session) {
                        setIsAuthenticated(false); // Якщо немає сесії або є помилка, авторизація не пройдена
                        router.replace("/auth"); // Перенаправлення на сторінку авторизації
                    } else {
                        setIsAuthenticated(true); // Якщо є сесія, користувач авторизований
                    }
    ...
    // Якщо сторінка ще завантажується, відображаємо лоадер
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: "Loading..."
        }, void 0, false, {
...
_s(RootLayout, "+Woren/6xqW0TFye6U3hkksO2/U=", false, function() {
    return [
...
//# sourceMappingURL=src_3c64bf._.js.map