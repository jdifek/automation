(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_ef119f._.js", {
...
function Wrapper({ children }) {
                ...
                "Wrapper.useEffect.getSession": async ()=>{
                    ...
                    try {
                        ...
                        if (session) {
                            ...
                            router.push("/login"); // Редирект на сторінку логіну
                        }
                    } catch (error) {
    ...
    if (!authenticated) {
        return null; // Не рендеримо контент до завершення редиректу
    }
...
//# sourceMappingURL=src_app_ef119f._.js.map